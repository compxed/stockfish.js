...
#ifdef USE_LITE_NET
// Lite mode: a single small feature set. It is aliased to PSQFeatureSet so
// that the accumulator code stays identical to the full build.
using FeatureSet    = Features::P_hm;
using PSQFeatureSet = FeatureSet;
#else
