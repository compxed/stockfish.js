...
inline void Position::put_piece(Piece pc, Square s, [[maybe_unused]] DirtyThreats* const dts) {
    board[s] = pc;
...
inline void Position::remove_piece(Square s, [[maybe_unused]] DirtyThreats* const dts) {
    Piece pc = board[s];
...
inline void Position::move_piece(Square from, Square to, [[maybe_unused]] DirtyThreats* const dts) {
    Piece    pc     = board[from];
...
inline void Position::swap_piece(Square s, Piece pc, [[maybe_unused]] DirtyThreats* const dts) {
    [[maybe_unused]] Piece old = board[s];
